...
const groupedTechs = TECH_STACK.reduce(
  (acc, curr) => {
...
export default function SkillsPage() {
  return (
    <div className="relative bg-background overflow-x-hidden">
      ...
      >
        <Container delay={0.1} className="max-w-3xl mx-auto px-4 py-2">
                    ...
                    {groupedTechs[category].map((tech) => {
                      const iconSrc = tech.theme
                        ...
                        : tech.icon.startsWith("/")
                          ...
                          : `/icons/${tech.icon}`;
                      const darkIconSrc =
                        tech.theme && tech.darkIcon
                          ? tech.darkIcon.startsWith("/")
                            ? tech.darkIcon
                            : `/icons/${tech.darkIcon}`
                          : null;
